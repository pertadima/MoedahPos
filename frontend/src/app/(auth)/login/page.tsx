...
const SLIDES = [
  ...
  {
    id: 3,
    light: '/image-table-light.png',
    dark: '/image-table-dark.png',
    title: 'Manajemen Meja',
    subtitle: 'Kelola meja restoran, reservasi, dan pesanan makan di tempat dengan mudah.',
  },
  {
    id: 4,
    light: '/image-kitchen-light.png',
    dark: '/image-kitchen-dark.png',
    title: 'Kitchen Display System',
    subtitle: 'Tampilkan pesanan di dapur secara real-time untuk layanan lebih cepat.',
  },
  {
    id: 5,
